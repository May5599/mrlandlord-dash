...
//     request.assignedVendorId !== selectedVendor
//   ) {
//     setSelectedVendor(request.assignedVendorId);
//   }

//   if (request.scheduledDate !== scheduledDate) {
//     setScheduledDate(request.scheduledDate ?? "");
//   }

//   if (request.scheduledTimeFrom !== scheduledFrom) {
//     setScheduledFrom(request.scheduledTimeFrom ?? "");
//   }

//   if (request.scheduledTimeTo !== scheduledTo) {
//     setScheduledTo(request.scheduledTimeTo ?? "");
//   }
// }, [request]);

    ...
    <div className="relative min-h-screen flex flex-col bg-white overflow-hidden isolate">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
          ...
          <FeatureCard
            title="Centralized Control"
            description="Manage multiple properties, tenants, and vendors from a single streamlined control panel."
          />

          <FeatureCard
            title="Smart Maintenance Workflow"
            description="Track issues in real time, assign vendors, monitor progress, and maintain complete service history."
          />

          <FeatureCard
            title="Scalable Infrastructure"
            description="Designed for multi-branch operators with reporting, oversight tools, and structured performance tracking."
          />
...
<section className="py-24 px-6 bg-white">
  ...
  <div className="max-w-3xl mx-auto text-center">
    ...
    <p className="mt-4 text-gray-600">
      Tell us a bit about your property portfolio and we will schedule a demo.
    </p>
    ...
    >
      ...
      <input
        type="hidden"
        name="_subject"
        value="New Demo Request - MrLandlord"
      />
      ...
      <input
        ...
        className="w-full px-5 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
      />
      ...
      <input
        type="text"
        name="company"
        placeholder="Company / Property Portfolio"
        className="w-full px-5 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
      />
      ...
      <select
        ...
        className="w-full px-5 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
      >
        <option value="">Number of Units Managed</option>
        <option>1 - 10</option>
        <option>11 - 50</option>
      ...
      <select
        ...
        className="w-full px-5 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
      >
        <option value="">Current Property Management Software</option>
      ...
      <button
        type="submit"
        className="w-full px-8 py-4 rounded-2xl bg-indigo-600 text-white font-medium shadow-lg hover:bg-indigo-700 transition"
      >
        Request Demo
      </button>

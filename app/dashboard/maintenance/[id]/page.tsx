...
//   const { id } = useParams(); // maintenance ID from URL
...
//           <Detail label="Access Preference" value={request.accessPreference || "Not provided"} />
//           <Detail label="Created" value={new Date(request.createdAt).toLocaleDateString()} />
//         </div>
...
//         {/* MANAGER ACTIONS */}
//         <h3 className="mt-8 font-semibold text-lg">Manager Controls</h3>
